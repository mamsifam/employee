...
txtname=Entry(entry_frame,textvariable=name,font=('calibri',16),width=30)
...
txtage=Entry(entry_frame,textvariable=age,font=('calibri',16),width=30)
...
txtdoj=Entry(entry_frame,textvariable=doj,font=('calibri',16),width=30)
...
txtemail=Entry(entry_frame,textvariable=age,font=('calibri',16),width=30)
...
combogender=ttk.Combobox(entry_frame,font=('calibri',16),textvariable=gender,width=20)
